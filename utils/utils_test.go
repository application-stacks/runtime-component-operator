...
var (
	...
	fclEmpty = fakeclient.NewClientBuilder().WithObjects().Build()
)
...
func TestEnsureOwnerRef(t *testing.T) {
	...
	ownerRef := runtime.GetOwnerReferences()[0]

	newOwnerRef2 := metav1.OwnerReference{APIVersion: "test", Kind: "test", Name: "testRef", UID: "test"}
	EnsureOwnerRef(runtime, newOwnerRef2)
	ownerRef2 := runtime.GetOwnerReferences()[0]

	testOR := []Test{
		{"Test owner reference", ownerRef, newOwnerRef},
		{"Test owner reference 2", ownerRef2, newOwnerRef2},
	}
