...
[source,sh]
----
    kubectl apply -f https://raw.githubusercontent.com/application-stacks/runtime-component-operator/main/internal/deploy/1.2.0/kubectl/runtime-component-crd.yaml
----
