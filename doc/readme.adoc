...
** For operator versions **0.8.x**, refer to this link:++user-guide-v1beta2.adoc++[user guide]. Note that these versions are **no longer supported**. You must migrate to 1.2.0 or above.
