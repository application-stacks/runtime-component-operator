...
| `affinity.nodeAffinity` | A YAML object representing a link:++https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#nodeaffinity-v1-core++[NodeAffinity].
| `affinity.nodeAffinityLabels` | A YAML object containing set of required labels and their values.
| `affinity.podAffinity` | A YAML object representing a link:++https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#podaffinity-v1-core++[PodAffinity].
| `affinity.podAntiAffinity` | A YAML object representing a link:++https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#podantiaffinity-v1-core++[PodAntiAffinity].
...
Using `nodeAffinityLabels` field it is possible to set required labels for pod scheduling on specific nodes:
...
Require a large node type and prefer zone A and zone B
...
Bellow example shows required pod affinity where pod for service A and B should be co-located in the same zone. Additionally, it is preferred not to schedule on hosts that are running service C.
