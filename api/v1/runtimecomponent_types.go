...
// +kubebuilder:printcolumn:name="Warning",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status",priority=0,description="Status of the component warning condition"
// +kubebuilder:printcolumn:name="WarningReason",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].reason",priority=1,description="Reason for the failure of component warning condition"
// +kubebuilder:printcolumn:name="WarningMessage",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].message",priority=1,description="Failure message from component warning condition"
...
func (cr *RuntimeComponent) GetServiceAccount() common.BaseComponentServiceAccount {
...
func (sa *RuntimeComponentServiceAccount) GetMountToken() *bool {
