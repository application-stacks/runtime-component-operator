[![Build Status](https://travis-ci.org/application-stacks/runtime-component-operator.svg?branch=master)](https://travis-ci.org/application-stacks/runtime-component-operator)
