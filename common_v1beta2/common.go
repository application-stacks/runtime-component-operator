...
func GetDefaultMicroProfileStartupProbeV1Beta2(ba BaseComponent) *corev1.Probe {
	return &corev1.Probe{
...
func GetDefaultMicroProfileReadinessProbeV1Beta2(ba BaseComponent) *corev1.Probe {
	return &corev1.Probe{
		ProbeHandler: corev1.ProbeHandler{
			HTTPGet: &corev1.HTTPGetAction{
				Path:   "/health/ready",
...
func GetDefaultMicroProfileLivenessProbeV1Beta2(ba BaseComponent) *corev1.Probe {
	return &corev1.Probe{
		ProbeHandler: corev1.ProbeHandler{
			HTTPGet: &corev1.HTTPGetAction{
				Path:   "/health/live",
