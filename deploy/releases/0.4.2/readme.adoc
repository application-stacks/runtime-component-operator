...
All notable changes are documented in the link:++/CHANGELOG.md#0.4.2++[Changelog].
...
[source,sh]
----
    kubectl apply -f https://raw.githubusercontent.com/application-stacks/runtime-component-operator/main/deploy/releases/0.4.2/runtime-component-crd.yaml
----
...
[source,sh]
----
    curl -L https://raw.githubusercontent.com/application-stacks/runtime-component-operator/main/deploy/releases/0.4.2/runtime-component-cluster-rbac.yaml \
...
[source,sh]
----
    curl -L https://raw.githubusercontent.com/application-stacks/runtime-component-operator/main/deploy/releases/0.4.2/runtime-component-operator.yaml \
