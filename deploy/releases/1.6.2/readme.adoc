= Runtime Component Operator v1.6.2
...
Red Hat OpenShift 4.18 or higher is supported. The operator is also supported on Kubernetes environments with v1.31 or higher.
