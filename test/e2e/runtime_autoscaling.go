...
func RuntimeAutoScalingTest(t *testing.T) {
	...
	// Get the application
	f.Client.Get(goctx.TODO(), types.NamespacedName{Name: "example-runtime-autoscaling", Namespace: namespace}, runtimeComponent)
	if err != nil {
		t.Fatal(err)
	}
	runtimeComponent.Spec.ResourceConstraints = setResources("0.2")
	runtimeComponent.Spec.Autoscaling = setAutoScale(5, 50)
	err = f.Client.Update(goctx.TODO(), runtimeComponent)
	if err != nil {
		t.Fatal(err)
	}
...
func updateTest(t *testing.T, f *framework.Framework, runtimeComponent *appstacksv1beta1.RuntimeComponent, options k.ListOptions, namespace string, hpa *autoscalingv1.HorizontalPodAutoscalerList) {
	...
	// }
	// Get the application
	err := f.Client.Get(goctx.TODO(), types.NamespacedName{Name: "example-runtime-autoscaling", Namespace: namespace}, runtimeComponent)
	if err != nil {
		t.Fatal(err)
	}
	runtimeComponent.Spec.ResourceConstraints = setResources("0.2")
	runtimeComponent.Spec.Autoscaling = setAutoScale(3, 2, 30)
	err = f.Client.Update(goctx.TODO(), runtimeComponent)
	if err != nil {
		t.Fatal(err)
	}
...
func minMaxTest(t *testing.T, f *framework.Framework, runtimeComponent *appstacksv1beta1.RuntimeComponent, options k.ListOptions, namespace string, hpa *autoscalingv1.HorizontalPodAutoscalerList) {
	...
	runtimeComponent.Spec.ResourceConstraints = setResources("0.2")
	runtimeComponent.Spec.Autoscaling = setAutoScale(1, 6, 10)
	err = f.Client.Update(goctx.TODO(), runtimeComponent)
	if err != nil {
		t.Fatal(err)
	}
...
func minBoundaryTest(t *testing.T, f *framework.Framework, runtimeComponent *appstacksv1beta1.RuntimeComponent, options k.ListOptions, namespace string, hpa *autoscalingv1.HorizontalPodAutoscalerList) {
	...
	runtimeComponent.Spec.ResourceConstraints = setResources("0.5")
	runtimeComponent.Spec.Autoscaling = setAutoScale(4, 0, 20)
	err = f.Client.Update(goctx.TODO(), runtimeComponent)
	if err != nil {
		t.Fatal(err)
	}
...
func incorrectFieldsTest(t *testing.T, f *framework.Framework, ctx *framework.TestCtx) {
	...
	runtimeComponent.Spec.ResourceConstraints = setResources("0.3")
	runtimeComponent.Spec.Autoscaling = setAutoScale(4)
	err = f.Client.Update(goctx.TODO(), runtimeComponent)
	if err != nil {
		t.Fatal(err)
	}
